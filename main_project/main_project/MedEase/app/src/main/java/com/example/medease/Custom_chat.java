...
public class Custom_chat extends ArrayAdapter<String>
{
    ...
    public Custom_chat(Activity context, String[] message, String[] sid, String[] date)
    {
        //constructor of this class to get the values from main_activity_class

        super(context, R.layout.activity_custom_chat, message);
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        View listViewItem = inflater.inflate(R.layout.activity_custom_chat, null, true);
        ...
        if(sid[position].equalsIgnoreCase(sh.getString("login_id", "")))
        {
