...
public class User_chat extends Activity  implements JsonResponse
{
    EditText ed1;
    ImageView b1;
    String chat;
        ...
        b1.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View arg0)
            {
                ...
                else
                {
                    ...
                    JR.json_response=(JsonResponse) User_chat.this;
                    String q = "/userchat?sender_id="+sh.getString("login_id","") + "&chat="+chat + "&rid=" + Viewmedicine.lid;
                    q=q.replace(" ","%20");
                    JR.execute(q);
    ...
    void getChats() {
        ...
        JsonReq JR=new JsonReq();
        JR.json_response=(JsonResponse) User_chat.this;
        String q = "/viewchat?sender_id="+sh.getString("login_id","") +"&receiver_id=" + Viewmedicine.lid;
        q=q.replace(" ","%20");
